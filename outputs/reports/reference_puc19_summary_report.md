...
| Mutation report CSV | `outputs/tables/reference_puc19_mutation_report.csv` |
| Alignment preview | `outputs/reports/reference_puc19_alignment.txt` |
| Plasmid map image | `Not included` |
